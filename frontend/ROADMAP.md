...
**Глобальный прогресс:**
- [ ] Этап 1. Каркас проекта, архитектура, зависимости
- [ ] Этап 2. Сетевой слой + модели (DTO под контракт бэка)
- [ ] Этап 3. Аутентификация по телефону (OTP) + хранение токенов
- [ ] Этап 4. Профиль (свой и чужой) + **обязательный онбординг: фото и «о себе»**
- [ ] Этап 5. Лента событий: список + карта + фильтры (**в ленте — только день, точное время скрыто**)
- [ ] Этап 6. Карточка события и создание события (точное время появляется после подтверждения)
- [ ] Этап 7. Заявки и управление участниками (организатор решает, кого пускать)
- [ ] Этап 8. Чат на «беседах» (WebSocket) + вкладка «Чаты»
- [ ] Этап 9. Отзывы и рейтинг
- [ ] Этап 10. Push-уведомления (APNs/FCM)
- [ ] Этап 11. Жалобы/блокировки, полировка, релизная готовность
- [ ] Этап 12 (V2). Самостоятельные групповые чаты (мессенджер для устоявшихся компаний)
